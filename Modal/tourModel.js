...
const tourSchema = mongoose.Schema(
  {
    ...
    //Array //this will store the id of the user whose roles are guides
  },
  {
...
//virtual populate - basically to do 2 way referencing
...
// this middleware is to embeded the details of the guides in the tour details
// tourSchema.pre('save',async function(next){
//     const guides = this.guides;
//     const GuidesArray = [];
//     for (let i=0;i < guides.length;i++){
//         const user = await User.findById(guides[i]);
//         GuidesArray.push(user);
//     }
